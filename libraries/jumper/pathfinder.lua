...
if (...) then
  ...
  -- Dependencies
	...
	local Assert    = require ('libraries/jumper.core.assert')
  local Heap      = require ('libraries/jumper.core.bheap')
  ...
  local ASTAR     = require ('libraries/jumper.search.astar')
  local DIJKSTRA  = require ('libraries/jumper.search.dijkstra')
  local THETASTAR = require ('libraries/jumper.search.thetastar')
  local BFS      = require ('libraries/jumper.search.bfs')
  local DFS       = require ('libraries/jumper.search.dfs')
  local JPS      = require ('libraries/jumper.search.jps')
